        ...
        <div className="space-y-4">
          ...
          <div className="border rounded-md overflow-hidden">
            <Table>
              ...
              <TableBody>
                {filteredEmployees.length > 0 ? filteredEmployees.map(employee => <TableRow key={employee.id}>
          ...
          {!masterGeofencingEnabled && <p className="text-sm text-muted-foreground italic">
