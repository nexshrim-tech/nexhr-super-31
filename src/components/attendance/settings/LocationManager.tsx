...
import EmployeeGeofencingTable from "./EmployeeGeofencingTable";
...
const LocationManager = ({ 
  ...
  return (
    <div className="space-y-6 w-full">
      ...
      {/* Employee Individual Geofencing Controls */}
      <EmployeeGeofencingTable masterGeofencingEnabled={geofencingEnabled} />
    </div>
  );
};
