...
const UserHeader = ({ title }: UserHeaderProps) => {
  ...
  return (
    <div className="flex justify-between items-center p-4 mb-6 border-b bg-gradient-to-r from-white to-gray-50 shadow-md rounded-b-lg transition-all duration-300">
      <div className="flex items-center gap-3">
        ...
        <div className="flex flex-col">
          ...
          {title && (
            <div className="text-base font-medium mt-1 bg-gradient-to-r from-nexhr-primary to-purple-600 bg-clip-text text-transparent animate-fade-in flex items-center">
              {title}
              <Sparkles className="h-4 w-4 ml-1 text-yellow-400 animate-pulse-slow" />
            </div>
          )}
        </div>
      </div>
